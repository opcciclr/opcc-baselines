...
def ensemble_voting(eval_df: pd.DataFrame,
    ...
    horizons = eval_df['policy_horizon'].values
    ...
    for ensemble_count in np.arange(min(ensemble_size_interval, num_ensemble),
        ...
        for horizon in horizon_candidates:
            ...
            info = {'prediction': prediction,
                    ...
                    'query_distance_a': eval_df['query_distance_a'].values[_filter],
                    'query_distance_b': eval_df['query_distance_b'].values[_filter]}
